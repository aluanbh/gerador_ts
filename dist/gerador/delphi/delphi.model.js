...
class DelphiModel {
    constructor(tabela, dataPacket, relacionamentos) {
        ...
        this.properties = []; // armazena as property que são geradas na unit
        this.fieldsObj = []; // armazena os objetos - relacionamentos OneToOne
        this.fieldsList = []; // armazena as listas - relacionamentos OneToMany
        this.constDestInterface = []; // armazena as declaração do construtor e destrutor
        this.propertiesObj = []; // armazena as property do tipo OneToOne
        this.propertiesList = []; // armazena as property do tipo OneToMany
        this.constImplementation = []; // armazena a implementação do contrutor
        this.destImplementation = []; // armazena a implementação do destrutor
        // nome da classe
...
//# sourceMappingURL=delphi.model.js.map
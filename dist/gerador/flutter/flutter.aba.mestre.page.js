...
exports.FlutterAbaMestrePage = void 0;
const lodash = require("lodash");
/// classe base que ajuda a gerar o a página mestre das abas do Flutter usando o mustache
class FlutterAbaMestrePage {
    constructor(tabela, relacionamentos) {
        this.imports = []; // armazena os demais imports para a classe
        this.keysOneToOne = []; // armazena as keys do scafold e do form para páginas OneToOne - Ex: PessoaFisica e PessoaJuridica
        this.abasOneToOne = []; // armazena as abas OneToOne
        this.abasOneToMany = []; // armazena as abas OneToMany
        this.salvarFormsOneToOne = []; // armazena o código de salvamento dos forms OneToOne
        // nome da classe
...
exports.FlutterAbaMestrePage = FlutterAbaMestrePage;
//# sourceMappingURL=flutter.aba.mestre.page.js.map
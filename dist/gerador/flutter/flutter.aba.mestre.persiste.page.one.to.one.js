...
exports.FlutterAbaMestrePersistePageOneToOne = void 0;
...
class FlutterAbaMestrePersistePageOneToOne {
    constructor(tabela, tabelaMestre, dataPacket) {
        this.imports = []; // armazena os demais imports para a classe
        this.inputController = []; // armazena o código referente às variáveis Controller vinculadas aos inputs de lookup e que tem máscaras
        this.inputLookup = []; // armazena os widgets input de lookup
        this.inputNormal = []; // armazena os widgets input normais
        // trata imports
                    ...
                    if (tipoControle != null) {
                        ...
                        if (tipoControle.tipo == 'textFormField') {
                            if (campoLookupComTabela != '') { // monta o campo de lookup
                                ...
                                //     this.inputLookup.push("\t\t\t\t\t\twidget." + this.objetoMestre + "?." + this.objetoPrincipal + "?." + campoLookupComTabela + " = int.tryParse(value);");
                                // } else {
                                //     this.inputLookup.push("\t\t\t\t\t\twidget." + this.objetoMestre + "?." + this.objetoPrincipal + "?." + campoLookupComTabela + " = value;");
                                // }
                                ...
                                if (this.objetoJsonComentario.campoLookupTipoDado == "int") {
                                    this.inputLookup.push("\t\t\t\t\t\twidget." + this.objetoMestre + "?." + this.objetoPrincipal + "?." + campoLookupComTabela + " = int.tryParse(text);");
                                }
                                else {
                                    this.inputLookup.push("\t\t\t\t\t\twidget." + this.objetoMestre + "?." + this.objetoPrincipal + "?." + campoLookupComTabela + " = text;");
                                }
                                ...
                                this.inputLookup.push("\t\t\t\t\t\twidget." + this.objetoMestre + "." + this.objetoPrincipal + "?." + nomeCampoAtributo + " = objetoJsonRetorno['id'];");
                                ...
                                if (tipoControle.mascara != '' && tipoControle.mascara != null) {
                                    ...
                                    if (tipoCampo.includes('decimal')) {
                                        ...
                                        this.inputController.push("var " + nomeCampoAtributo + "Controller = new MoneyMaskedTextController(precision: Constantes." + casasDecimais + ", initialValue: widget." + this.objetoMestre + "?." + this.objetoPrincipal + "?." + nomeCampoAtributo + " ?? 0);");
                                    }
                                    else {
                                        ...
                                        this.inputController.push("\ttext: widget." + this.objetoMestre + "?." + this.objetoPrincipal + "?." + nomeCampoAtributo + " ?? '',");
                                    ...
                                    if (tipoCampo.includes('int')) {
                                        this.inputNormal.push("\tinitialValue: widget." + this.objetoMestre + "?." + this.objetoPrincipal + "?." + nomeCampoAtributo + "?.toString() ?? '',");
                                    }
                                    else {
                                        this.inputNormal.push("\tinitialValue: widget." + this.objetoMestre + "?." + this.objetoPrincipal + "?." + nomeCampoAtributo + " ?? '',");
                                    }
                                }
                                ...
                                // 20200105 - EIJE - porção de código movida para o método onChanged
                                // if (tipoCampo.includes('decimal')) {
                                //     this.inputNormal.push("\t\twidget." + this.objetoMestre + "." + this.objetoPrincipal + "." + nomeCampoAtributo + " = " + nomeCampoAtributo + "Controller.numberValue;");
                                // } else if (tipoCampo.includes('int')) {
                                //     this.inputNormal.push("\t\twidget." + this.objetoMestre + "." + this.objetoPrincipal + "?." + nomeCampoAtributo + " = int.tryParse(value);");
                                // } else {
                                //     this.inputNormal.push("\t\twidget." + this.objetoMestre + "." + this.objetoPrincipal + "?." + nomeCampoAtributo + " = value;");
                                // }                                
                                ...
                                if (tipoCampo.includes('decimal')) {
                                    ...
                                    this.inputNormal.push("\t\twidget." + this.objetoMestre + "." + this.objetoPrincipal + "?." + nomeCampoAtributo + " = int.tryParse(text);");
                                }
                                else {
                                    this.inputNormal.push("\t\twidget." + this.objetoMestre + "." + this.objetoPrincipal + "?." + nomeCampoAtributo + " = text;");
                                }
                            ...
                            this.inputNormal.push("\tisEmpty: widget." + this.objetoMestre + "?." + this.objetoPrincipal + "?." + nomeCampoAtributo + " == null ||");
                            this.inputNormal.push("\t\twidget." + this.objetoMestre + "?." + this.objetoPrincipal + " == null,");
                            this.inputNormal.push("\tchild: ViewUtilLib.getDropDownButton(widget." + this.objetoMestre + "." + this.objetoPrincipal + "?." + nomeCampoAtributo + ",");
                            this.inputNormal.push("\t\t(String newValue) {");
                            this.inputNormal.push("\tViewUtilLib.paginaMestreDetalheFoiAlterada = true;");
                            this.inputNormal.push("\tsetState(() {");
                            this.inputNormal.push("\t\twidget." + this.objetoMestre + "." + this.objetoPrincipal + "?." + nomeCampoAtributo + " = newValue;");
                            this.inputNormal.push("\t});");
                            ...
                            this.inputNormal.push("\t\tdateTime: widget." + this.objetoMestre + "." + this.objetoPrincipal + "?." + nomeCampoAtributo + ",");
...
exports.FlutterAbaMestrePersistePageOneToOne = FlutterAbaMestrePersistePageOneToOne;
//# sourceMappingURL=flutter.aba.mestre.persiste.page.one.to.one.js.map
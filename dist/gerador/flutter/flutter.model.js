...
class FlutterModel {
    constructor(tabela, dataPacket, relacionamentos) {
        this.listaDeCampos = []; // armazena a lista de campos separado por vírgulas - ex: ['ID', 'TIPO', 'NUMERO']
        this.listaDeColunas = []; // armazena a lista de colunas separado por vírgulas - ex: ['Id', 'Tipo', 'Número'];
        ...
        this.atributConstrutor = []; // armazena os Atributos da classe para o construtor
        this.atributObjConstrutor = []; // armazena os objetos - relacionamentos OneToOne para o construtor
        this.atributListConstrutor = []; // armazena as listas - relacionamentos OneToMany para o construtor
        this.atributFromJson = []; // armazena os Atributos da classe para o método FromJson
        this.atributObjFromJson = []; // armazena os objetos - relacionamentos OneToOne para o método FromJson
        this.atributListFromJson = []; // armazena as listas - relacionamentos OneToMany para o método FromJson
        this.atributToJson = []; // armazena os Atributos da classe para o método ToJson
        this.atributObjToJson = []; // armazena os objetos - relacionamentos OneToOne para o método ToJson
        this.atributListToJson = []; // armazena as listas - relacionamentos OneToMany para o método ToJson
...
exports.FlutterModel = FlutterModel;
//# sourceMappingURL=flutter.model.js.map
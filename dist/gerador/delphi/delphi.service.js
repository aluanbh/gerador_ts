...
class DelphiService {
    constructor(tabela, dataPacket, relacionamentos) {
        ...
        this.anexaObjetosVinculadosImplementationObjetoAbertura = []; // armazena o código de abertura do método para objeto
        this.anexaObjetosVinculadosImplementationObjetoFechamento = []; // armazena o código de fechamento do método para objeto
        ...
        this.insereExcluiObjetosFilhosInterface = []; // armazena o código da interface dos para os métodos de adição e exclusão dos objetos filhos
        this.insereObjetosFilhosImplementationAbertura = []; // armazena o código de abertura do método para inserir os objetos vinculados
        this.insereObjetosFilhosImplementationFechamento = []; // armazena o código de fechamento do método para inserir os objetos vinculados
        this.excluiObjetosFilhosImplementationAbertura = []; // armazena o código de abertura do método para excluir os objetos vinculados
        this.excluiObjetosFilhosImplementationFechamento = []; // armazena o código de fechamento do método para ecluir os objetos vinculados
        this.insereObjetosVinculados = []; // armazena o código de inserção dos objetos vinculados
        this.excluiFilhos = []; // armazena o código para exclusão dos ojetos filhos vinculados
        // nome da classe
    ...
    gerarCodigoObjetosVinculados(relacionamentos) {
...
//# sourceMappingURL=delphi.service.js.map
...
class PHPModel {
    constructor(tabela, dataPacket, relacionamentos) {
        ...
        this.mapeamentoSimples = []; // mapeamento no construtor - atributos simples
        this.mapeamentoObj = []; // mapeamento no construtor - objetos
        this.mapeamentoList = []; // mapeamento no construtor - listas
        this.serializeSimples = []; // serialize JSON - atributos simples
        this.serializeObj = []; // serialize JSON - objetos
        this.serializeList = []; // serialize JSON - listas
    ...
    defineGetSetObjeto(nomeCampoGetSet, nomeCampoAtributo) {
...
exports.PHPModel = PHPModel;
//# sourceMappingURL=php.model.js.map